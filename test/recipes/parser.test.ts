...
describe('Recipe Parser', () => {
  describe('Parse NYT correctly', function () {
    it('return correct recipe', async function () {
        let recipe = await parseRecipeFromURL("https://cooking.nytimes.com/recipes/1022064-roasted-salmon-with-asparagus-lemon-and-brown-butte")
  ...
  describe('Parse HowToSection and HowToStep in same array correctly', function () {
    it('returns correct recipe', async function () {
        let recipe = await parseRecipeFromURL("https://addapinch.com/the-best-chocolate-cake-recipe-ever")
        let expectedRecipe:Recipe = {
  ...
  describe('Parse HowToSections array correctly', function () {
    it('returns correct recipe', async function () {
        let recipe = await parseRecipeFromURL("https://ohsweetbasil.com/moist-chocolate-zucchini-cake-recipe")
        let expectedRecipe:Recipe = {
